...
int main()
{
    ...
    Panel::Panel_Properties panel_props{ sf::Vector2f(200, 300), Panel::anchor_point::top_right };
    Panel& panel_to_edit = my_gui.Add_Panel(panel_props);
    Panel_Element::Element_Properties element_props{ sf::Vector2f(50, 50), sf::Vector2f(25, 25), sf::Vector2f(100,0) };
